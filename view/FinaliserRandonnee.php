            ...
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <form action="../controlleur/controlLogout.php" method="post">
                        <input type="submit" id="logout" name="logout" class="logout-custom" value='Log out'>
                    </form>
                </li>
            </ul>
            <img
...
?>
    ...
    <div class="container mt-5">
        ...
        <table class="table">
          ...
          <tbody>
            <?php
            echo Randonnee::getRandoEnAttenteNonFinalisee();
            ?>
          </tbody>
        </table>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="objectif"readonly name="objectif"
                    value="<?php echo $objectif; ?>" required>
            </div>
            <div class="form-group">
                <label for="ville">Ville:</label>
                <input type="text" class="form-control" id="ville" readonly name="ville" value="<?php echo $ville; ?>"
                    required>
            </div>
            <div class="form-group">
                <label for="desc">Description:</label>
                <input type="text" class="form-control" id="desc" readonly name="desc"
                    value="<?php echo $desc; ?>" required>
            </div>
            <div class="form-group">
                <label for="nomRand">Nom du Randonneur:</label>
                <input type="text" class="form-control" id="nomRand" readonly name="nomRand"
                    value="<?php echo $login; ?>" required>
            </div>
            <div class="form-group">
    <label for="bus">Bus:</label>
    <select class="form-control" id="bus" name="bus"readonly required>
    <?php
        $busOptions = bus::getBusColl();
        foreach ($busOptions as $bus) {
            $selected = ($bus['matricule'] == $bus) ? 'selected' : '';
            echo "<option readonly value='{$bus['matricule']}' $selected>{$bus['matricule']}</option>";
        }
        ?>
    </select>
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="dateDeb" readonly name="dateDeb"
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="etat" name="etat" readonly required>
                    <option readonly value="en attente" <?php if ($etat == 'en attente')
                        echo 'selected'; ?>>En Attente</option>
                    <option readonly value="en cours" <?php if ($etat == 'en cours')
                        echo 'selected'; ?>>En Cours</option>
                    <option readonly value="finalisee" <?php if ($etat == 'finalisee')
